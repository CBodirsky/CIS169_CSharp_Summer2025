...
* Description : This program creates and tests constructors
*               Input:  None
*               Output: None
...
namespace AddressClass
{
    public class Address
    {
        ...
        public Address(string streetNumber, string streetName, string apt, string city, string state, string zip)
        {
